...
/// CROSS RSDPG-192-balanced digital signatures (code-based signatures, 192-bit security).
///
/// Balanced trade-off between signature size and signing speed.
///
/// ```swift
/// // Generate a signing key
/// let signer = try CrossRSDPG192Balanced.PrivateKey()
///
/// // Sign something
/// let sig = try signer.signature(for: messageData)
///
/// // Anyone with the public key can verify
/// let pub = try CrossRSDPG192Balanced.PublicKey(rawRepresentation: signerPublicKeyData)
...
/// let loaded = try CrossRSDPG192Balanced.PrivateKey(

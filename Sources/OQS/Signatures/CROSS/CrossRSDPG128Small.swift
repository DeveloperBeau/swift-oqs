...
///
/// CROSS is a code-based signature scheme. This RSDPG-128 variant provides 128-bit security with small signatures.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try CrossRSDPG128Small.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try CrossRSDPG128Small.PublicKey(rawRepresentation: alicePublicKeyData)
...
///
/// // Load
/// let loaded = try CrossRSDPG128Small.PrivateKey(

...
///
/// CROSS is a code-based signature scheme. This RSDPG-128 variant provides 128-bit security with fast signing.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try CrossRSDPG128Fast.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try CrossRSDPG128Fast.PublicKey(rawRepresentation: alicePublicKeyData)

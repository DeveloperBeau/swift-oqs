...
///
/// CROSS is a code-based signature scheme. This RSDP-128 variant provides 128-bit security with fast signing.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try CrossRSDP128Fast.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try CrossRSDP128Fast.PublicKey(rawRepresentation: alicePublicKeyData)
...
///
/// // Load
/// let loaded = try CrossRSDP128Fast.PrivateKey(

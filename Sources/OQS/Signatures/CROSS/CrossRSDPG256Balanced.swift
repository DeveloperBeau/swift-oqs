...
///
/// CROSS is a code-based signature scheme. This RSDPG-256 variant provides 256-bit security with balanced performance.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try CrossRSDPG256Balanced.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try CrossRSDPG256Balanced.PublicKey(rawRepresentation: alicePublicKeyData)
...
///
/// // Load
/// let loaded = try CrossRSDPG256Balanced.PrivateKey(

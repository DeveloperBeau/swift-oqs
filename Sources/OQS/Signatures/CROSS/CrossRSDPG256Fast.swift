...
///
/// CROSS is a code-based signature scheme. This RSDPG-256 variant provides 256-bit security with fast signing.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try CrossRSDPG256Fast.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try CrossRSDPG256Fast.PublicKey(rawRepresentation: alicePublicKeyData)
...
///
/// // Load
/// let loaded = try CrossRSDPG256Fast.PrivateKey(

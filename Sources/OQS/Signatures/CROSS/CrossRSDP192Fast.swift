...
///
/// CROSS is a code-based signature scheme. This RSDP-192 variant provides 192-bit security with fast signing.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try CrossRSDP192Fast.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try CrossRSDP192Fast.PublicKey(rawRepresentation: alicePublicKeyData)

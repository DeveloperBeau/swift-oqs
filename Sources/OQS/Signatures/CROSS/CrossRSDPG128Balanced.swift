...
///
/// CROSS is a code-based signature scheme. This RSDPG-128 variant provides 128-bit security with balanced performance.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try CrossRSDPG128Balanced.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try CrossRSDPG128Balanced.PublicKey(rawRepresentation: alicePublicKeyData)

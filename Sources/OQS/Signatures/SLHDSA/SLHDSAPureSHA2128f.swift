...
///
/// SLH-DSA (FIPS 205) is a NIST standard stateless hash-based signature scheme. This SHA2-128f variant provides 128-bit security optimized for fast signing.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try SLHDSAPureSHA2128f.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try SLHDSAPureSHA2128f.PublicKey(rawRepresentation: alicePublicKeyData)

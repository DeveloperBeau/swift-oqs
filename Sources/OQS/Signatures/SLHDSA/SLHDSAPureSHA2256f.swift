...
///
/// SLH-DSA (FIPS 205) is a NIST standard stateless hash-based signature scheme. This SHA2-256f variant provides 256-bit security optimized for fast signing.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try SLHDSAPureSHA2256f.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try SLHDSAPureSHA2256f.PublicKey(rawRepresentation: alicePublicKeyData)

...
/// SLH-DSA-SHA2-256f digital signatures (NIST standard (FIPS 205), hash-based, 256-bit security).
///
...
/// let signer = try SLHDSAPureSHA2256f.PrivateKey()
///
/// // Sign something
/// let sig = try signer.signature(for: messageData)
///
/// // Anyone with the public key can verify
/// let pub = try SLHDSAPureSHA2256f.PublicKey(rawRepresentation: signerPublicKeyData)
...
/// let loaded = try SLHDSAPureSHA2256f.PrivateKey(

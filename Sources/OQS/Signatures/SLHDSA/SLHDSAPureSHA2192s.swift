...
///
/// SLH-DSA (FIPS 205) is a NIST standard stateless hash-based signature scheme. This SHA2-192s variant provides 192-bit security optimized for small signatures.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try SLHDSAPureSHA2192s.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try SLHDSAPureSHA2192s.PublicKey(rawRepresentation: alicePublicKeyData)

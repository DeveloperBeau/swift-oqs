...
///
/// SLH-DSA (FIPS 205) is a NIST standard stateless hash-based signature scheme. This SHAKE-256f variant provides 256-bit security optimized for fast signing.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try SLHDSAPureSHAKE256f.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try SLHDSAPureSHAKE256f.PublicKey(rawRepresentation: alicePublicKeyData)
...
///
/// // Load
/// let loaded = try SLHDSAPureSHAKE256f.PrivateKey(

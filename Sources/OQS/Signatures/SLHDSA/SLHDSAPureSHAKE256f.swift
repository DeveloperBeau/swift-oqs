...
/// SLH-DSA-SHAKE-256f digital signatures (NIST standard (FIPS 205), hash-based, 256-bit security).
///
...
/// let signer = try SLHDSAPureSHAKE256f.PrivateKey()
///
/// // Sign something
/// let sig = try signer.signature(for: messageData)
///
/// // Anyone with the public key can verify
/// let pub = try SLHDSAPureSHAKE256f.PublicKey(rawRepresentation: signerPublicKeyData)

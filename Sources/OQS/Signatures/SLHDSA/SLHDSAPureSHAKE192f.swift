...
///
/// SLH-DSA (FIPS 205) is a NIST standard stateless hash-based signature scheme. This SHAKE-192f variant provides 192-bit security optimized for fast signing.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try SLHDSAPureSHAKE192f.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try SLHDSAPureSHAKE192f.PublicKey(rawRepresentation: alicePublicKeyData)
...
///
/// // Load
/// let loaded = try SLHDSAPureSHAKE192f.PrivateKey(

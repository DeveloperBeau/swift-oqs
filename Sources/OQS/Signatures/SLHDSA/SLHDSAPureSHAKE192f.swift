...
/// SLH-DSA-SHAKE-192f digital signatures (NIST standard (FIPS 205), hash-based, 192-bit security).
///
...
/// let signer = try SLHDSAPureSHAKE192f.PrivateKey()
///
/// // Sign something
/// let sig = try signer.signature(for: messageData)
///
/// // Anyone with the public key can verify
/// let pub = try SLHDSAPureSHAKE192f.PublicKey(rawRepresentation: signerPublicKeyData)

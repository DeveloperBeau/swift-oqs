...
/// SLH-DSA-SHA2-192f digital signatures (NIST standard (FIPS 205), hash-based, 192-bit security).
///
/// FIPS 205 standard. Uses SHA2 internally, optimized for fast signing.
/// Hash-based security — no lattice or code-based assumptions.
///
/// ```swift
/// // Generate a signing key
/// let signer = try SLHDSAPureSHA2192f.PrivateKey()
///
/// // Sign something
/// let sig = try signer.signature(for: messageData)
///
/// // Anyone with the public key can verify
/// let pub = try SLHDSAPureSHA2192f.PublicKey(rawRepresentation: signerPublicKeyData)
...
/// let loaded = try SLHDSAPureSHA2192f.PrivateKey(

...
/// SLH-DSA-SHAKE-192s digital signatures (NIST standard (FIPS 205), hash-based, 192-bit security).
///
...
/// let signer = try SLHDSAPureSHAKE192s.PrivateKey()
///
/// // Sign something
/// let sig = try signer.signature(for: messageData)
///
/// // Anyone with the public key can verify
/// let pub = try SLHDSAPureSHAKE192s.PublicKey(rawRepresentation: signerPublicKeyData)
...
/// let loaded = try SLHDSAPureSHAKE192s.PrivateKey(

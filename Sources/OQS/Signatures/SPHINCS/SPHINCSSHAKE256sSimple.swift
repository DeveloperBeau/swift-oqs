...
///
/// SPHINCS+ is a stateless, hash-based signature scheme offering conservative security. This SHAKE-256s variant provides 256-bit security optimized for small signatures.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try SPHINCSSHAKE256sSimple.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try SPHINCSSHAKE256sSimple.PublicKey(rawRepresentation: alicePublicKeyData)

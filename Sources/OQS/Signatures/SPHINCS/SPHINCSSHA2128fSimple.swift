...
///
/// SPHINCS+ is a stateless, hash-based signature scheme offering conservative security. This SHA2-128f variant provides 128-bit security optimized for fast signing.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try SPHINCSSHA2128fSimple.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try SPHINCSSHA2128fSimple.PublicKey(rawRepresentation: alicePublicKeyData)
...
///
/// // Load
/// let loaded = try SPHINCSSHA2128fSimple.PrivateKey(

...
/// SPHINCS+-SHA2-192s-simple digital signatures (hash-based, conservative, with no lattice assumptions, 192-bit security).
///
...
/// let signer = try SPHINCSSHA2192sSimple.PrivateKey()
///
/// // Sign something
/// let sig = try signer.signature(for: messageData)
///
/// // Anyone with the public key can verify
/// let pub = try SPHINCSSHA2192sSimple.PublicKey(rawRepresentation: signerPublicKeyData)

...
/// SPHINCS+-SHA2-256s-simple digital signatures (hash-based, conservative, with no lattice assumptions, 256-bit security).
///
...
/// let signer = try SPHINCSSHA2256sSimple.PrivateKey()
///
/// // Sign something
/// let sig = try signer.signature(for: messageData)
///
/// // Anyone with the public key can verify
/// let pub = try SPHINCSSHA2256sSimple.PublicKey(rawRepresentation: signerPublicKeyData)

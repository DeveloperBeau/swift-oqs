...
///
/// SPHINCS+ is a stateless, hash-based signature scheme offering conservative security. This SHAKE-256f variant provides 256-bit security optimized for fast signing.
///
/// ## Signing and Verifying
///
/// **Step 1 — Alice generates a signing key and shares her public key:**
/// ```swift
/// let aliceSigningKey = try SPHINCSSHAKE256fSimple.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try SPHINCSSHAKE256fSimple.PublicKey(rawRepresentation: alicePublicKeyData)
...
///
/// // Load
/// let loaded = try SPHINCSSHAKE256fSimple.PrivateKey(

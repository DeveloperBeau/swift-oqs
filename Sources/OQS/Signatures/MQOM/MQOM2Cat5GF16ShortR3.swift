...
/// mqom2_cat5_gf16_short_r3 digital signatures (MQOM2, MPC-in-the-head multivariate, NIST category 5, short profile, 3 rounds).
///
...
/// let signer = try MQOM2Cat5GF16ShortR3.PrivateKey()
///
/// // Sign something
/// let sig = try signer.signature(for: messageData)
///
/// // Anyone with the public key can verify
/// let pub = try MQOM2Cat5GF16ShortR3.PublicKey(rawRepresentation: signerPublicKeyData)
...
/// let loaded = try MQOM2Cat5GF16ShortR3.PrivateKey(
///     rawRepresentation: saved,
///     publicKeyRepresentation: signer.publicKey.rawRepresentation
/// )
/// ```
public enum MQOM2Cat5GF16ShortR3: Sendable {
    static let algorithmName = "mqom2_cat5_gf16_short_r3"
    ...
    public struct PrivateKey: Sendable {
        ...
        public init() throws {
            let kp = try sigGenerateKeyPair(algorithm: MQOM2Cat5GF16ShortR3.algorithmName)
            self.rawRepresentation = kp.secretKey
            self.publicKey = PublicKey(unchecked: kp.publicKey)
        }

        public init(rawRepresentation: Data, publicKeyRepresentation: Data) throws {
            let lengths = try sigExpectedKeyLengths(algorithm: MQOM2Cat5GF16ShortR3.algorithmName)
        ...
        public func signature(for data: Data) throws -> Data {
            try sigSign(algorithm: MQOM2Cat5GF16ShortR3.algorithmName, message: data, secretKey: rawRepresentation)
        }
    }
    ...
    public struct PublicKey: Sendable {
        ...
        public func isValidSignature(_ signature: Data, for data: Data) throws -> Bool {
            try sigVerify(algorithm: MQOM2Cat5GF16ShortR3.algorithmName, message: data, signature: signature, publicKey: rawRepresentation)
        }
    }
}

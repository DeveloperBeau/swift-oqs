...
/// Classic McEliece 8192128 key encapsulation (conservative choice, studied for 50+ years, but with very large keys).
///
/// The largest Classic McEliece parameter set. Maximum security, but public
/// keys are over 1.3 MB. Only practical when keys are distributed out-of-band.
///
/// ```swift
/// // Alice generates a key pair
/// let alice = try ClassicMcEliece8192128.PrivateKey()
///
/// // Bob gets Alice's public key and creates a shared secret
/// let pub = try ClassicMcEliece8192128.PublicKey(rawRepresentation: alicePublicKeyData)

...
/// HQC-128 key encapsulation (code-based KEM, NIST candidate, 128-bit security).
///
/// A code-based alternative to lattice KEMs. Useful if you want algorithm
/// diversity or don't fully trust lattice assumptions.
///
/// ```swift
/// // Alice generates a key pair
/// let alice = try HQC128.PrivateKey()
///
/// // Bob gets Alice's public key and creates a shared secret
/// let pub = try HQC128.PublicKey(rawRepresentation: alicePublicKeyData)

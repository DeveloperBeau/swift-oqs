...
///
/// HQC-256 is a code-based KEM and NIST candidate providing 256-bit security.
///
...
/// ```swift
/// let alicePrivateKey = try HQC256.PrivateKey()
...
/// ```swift
/// let alicePublicKey = try HQC256.PublicKey(rawRepresentation: alicePublicKeyData)

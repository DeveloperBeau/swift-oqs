...
#define APPLY_NAMESPACE oqs_sig_private_mqom2_cat3_gf16_short_r3_default_
#define APPLY_PUBLIC_API_NAMESPACE oqs_sig_pubapi_mqom2_cat3_gf16_short_r3_default_
...
#define USE_XOF_X4
#include "sig_mqom_mqom2_cat3_gf16_short_r3.c"
